...
class SimulateTestCase(unittest.TestCase):
    ...
    def test_add_new_frames(self):
        ...
        result, new_packet_seqs = add_new_frames(buffer_states, new_frames, packet_seqs)
        ...
        # Overflow should cap to queue capacity.
    ...
    def test_simulate(self):
        ...
        result_buffer_states, result_channel_state, result_packet_seqs = simulate(
            buffer_states, new_frames, actions, packet_seqs
        )
